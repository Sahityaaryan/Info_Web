          ...
          <div className="mb-7">
            ...
            {props.project.category === "Self" ? (
              ...
              <ul className="leading-loose">
                ...
                <li className="font-general-regular text-ternary-dark dark:text-ternary-light flex justify-start py-2">
                  <FiLinkedin className="mr-2 text-xl text-blue-500" />{" "}
                  <FiTwitter className="mx-2 text-xl text-blue-500" />{" "}
                  <FiInstagram className="mx-2 text-xl text-pink-400" />{" "}
                </li>
              </ul>
            )}
          </div>
