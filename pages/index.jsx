  ...
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch mt-6 pt-6">
          ...
          <div className="md:w-1/2">
            <div className="text-center md:text-left">
              <h2 className="text-3xl font-bold mb-4 mt-4 text-red-800">
                Welcome To <br></br>Advance Composite Manufacturing and
                Characterisation Centre
              </h2>
              <p className="text-lg">
                Plasma spray coating lab at the Indian Institute of Technology
                Patna (IIT Patna) adds a unique dimension to our campus life,
                fostering innovation, research, and hands-on learning
                experiences. Here's a glimpse into this exciting facet of campus
                life: Cutting-Edge Technology: Our campus boasts
                state-of-the-art facilities for plasma spraying, a cutting-edge
                technology used for surface modification and material
                enhancement.
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto items-center justify-center rounded-lg bg-gray-100 w-5/6 shadow-lg">
        <div className="font-bold text-4xl text-red-800 mt-6 pt-4">
          Team Leader
        </div>
        <div className="grid  grid-cols-3 justify-between mt-3 md:flex-row">
          ...
          <div className="mt-4">
            <div>
              ...
              <h1 className="pt-3">
                <span className="font-bold">ph: </span> +91-8750111166
              </h1>

              <h1 className="pt-2">
                <span className="font-bold">email: </span> smp.me@nitp.ac.in
              </h1>
              <div className="flex flex-col md:flex-row gap-x-4 w-full  gap-y-4">
                <button className="rounded-md bg-red-100 p-4">
                  <a href="">CV</a>
                </button>
                <button className="rounded-md bg-red-100 p-4">
